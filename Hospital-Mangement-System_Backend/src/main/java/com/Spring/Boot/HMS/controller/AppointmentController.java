...
import com.Spring.Boot.HMS.repository.AppointmentRespo;
...
public class AppointmentController {
	...
	@Autowired
	private com.Spring.Boot.HMS.repository.AppointmentRespo respo;
	
	public AppointmentController(AppointmentRespo respo) {
		super();
		this.respo = respo;
	}
